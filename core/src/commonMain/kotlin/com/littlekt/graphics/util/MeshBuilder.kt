...
class MeshBuilder(val geometry: MeshGeometry) {
    ...
    fun cube(props: CubeProps) {
        ...
        withColor(props.frontColor ?: color) {
            ...
            val i1 = vertex(
                tmpPos.set(props.origin.x + props.size.x, props.origin.y, props.origin.z + props.size.z),
                Vec3f.Z_AXIS,
                Vec2f(1f, 1f)
            )
            val i2 = vertex(
                ...
                ), Vec3f.Z_AXIS, Vec2f(1f, 0f)
            )
            val i3 = vertex(
                tmpPos.set(props.origin.x, props.origin.y + props.size.y, props.origin.z + props.size.z),
                Vec3f.Z_AXIS,
                Vec2f(0f, 0f)
            )
