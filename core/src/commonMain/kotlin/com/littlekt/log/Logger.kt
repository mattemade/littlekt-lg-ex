...
class Logger private constructor(val name: String, val dummy: Boolean) {
    ...
    var output: Output
        ...
        get() = Logger_outputs[name] ?: defaultOutput
    ...
    companion object {
        ...
        var defaultOutput: Output by KtAtomicRef(com.littlekt.log.DefaultLogOutput)
...
private typealias AtomicMap<K, V> = KtAtomicRef<Map<K, V>>
