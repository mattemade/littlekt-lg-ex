...
enum class LDtkLayerType(val value: String) {
    ...
    companion object : KSerializer<LDtkLayerType> {
        override val descriptor: SerialDescriptor
            get() {
                return PrimitiveSerialDescriptor("com.littlekt.file.ldtk.Type", PrimitiveKind.STRING)
            }
...
private object MultiAssociatedValueSerializer : KSerializer<MultiAssociatedValue> {
    override val descriptor: SerialDescriptor =
        buildClassSerialDescriptor("com.littlekt.file.ldtk.MultiAssociatedValueSerializer") {
...
enum class LDtkBgPos(val value: String) {
    ...
    companion object : KSerializer<LDtkBgPos> {
        override val descriptor: SerialDescriptor
            get() {
                return PrimitiveSerialDescriptor("com.littlekt.file.ldtk.BgPos", PrimitiveKind.STRING)
            }
...
enum class LDtkWorldLayout(val value: String) {
    ...
    companion object : KSerializer<LDtkWorldLayout> {
        override val descriptor: SerialDescriptor
            get() {
                return PrimitiveSerialDescriptor("com.littlekt.file.ldtk.WorldLayout", PrimitiveKind.STRING)
            }
