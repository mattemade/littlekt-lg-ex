...
import com.littlekt.util.internal.isFlagSet
...
open class Control : CanvasItem() {
     ...
     * for the control. An override can be removed with [remove].
     */
    val fontOverrides by lazy { OverrideMap<String, com.littlekt.graphics.g2d.font.BitmapFont>(::_onThemeValueChanged) }

    /**
     * A map for storing the result of [getThemeFont] when needed to prevent searching the tree every frame.
     */
    val fontCache by lazy { mutableMapOf<String, com.littlekt.graphics.g2d.font.BitmapFont>() }
    ...
    ): com.littlekt.graphics.g2d.font.BitmapFont {
